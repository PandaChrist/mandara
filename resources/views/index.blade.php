...
<head>
  ...
  <title>Mandara Restaurant-Lounge</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="../img/Mandara/favicon.png" rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <!-- <h1 class="logo me-auto me-lg-0"><a href="index.html">Mandara</a></h1> -->
      <!-- Uncomment below if you prefer to use an image logo  -->
      <a href="index.html" class="logo me-auto me-lg-0"><img src="../img/Mandara/Mandara2.png" alt="" class="img-fluid"></a>

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <!-- <li><a class="nav-link scrollto active" href="/inner-page">Home</a></li> -->
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>Bienvenu à <span>Mandara</span></h1>
          <h2>Where appetit greets authenticity</h2>

          <div class="btns">
            <a href="#menu" class="btn-menu animated fadeInUp scrollto">Nos Menu</a>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100">
            <div class="about-img">
              <img src="../img/Mandara/about.jpeg" alt="">
            </div>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>Pas juste un restaurant, une experience de retour aux sources grâce a nos plats authentiques</h3>
            <p class="fst-italic">
              Passez faire un tour chez nous.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> Un espace soigneux aux couleurs feutrées.</li>
              <li><i class="bi bi-check-circle"></i> Une cuisine constituées de plus de 70% de plats Africains cuisinés  à la manière traditionnel, et 30% de palts ouverts au monde.</li>
              <li><i class="bi bi-check-circle"></i> Des soirés karaoke, greet & meet et autres évènements plus originaux les uns que les autres.</li>
            </ul>
            <p>
    ...
    <section id="menu" class="menu section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Menu</h2>
          <p>Decouvrez nos savoureux menus</p>
        </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="menu-flters">
              ...
              <li data-filter=".filter-starters">Africains</li>
              <li data-filter=".filter-salads">Spécialité</li>
              <li data-filter=".filter-specialty">Monde</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            ...
            <div class="menu-content">
              <a href="#">Ndolè</a><span>4 000 Fcfa</span>
            </div>
            <div class="menu-ingredients">
              Lorem, deren, trataro, filede, nerada
            </div>
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            ...
            <div class="menu-content">
              <a href="#">Légumes sautés</a><span>3 000 Fcfa</span>
            </div>
            <div class="menu-ingredients">
    ...
    <section id="specials" class="specials">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Specialités</h2>
          <p>Quelques mots sur nos specialités</p>
        </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" href="#tab-1">Pilé pomme</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-2">Okok</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-3">Taro sauce jaune</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-4">Couscous sauce gombo</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-5">Couscous nkui</a>
              </li>
            </ul>
          </div>
            ...
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Pilé pomme</h3>
                    <p class="fst-italic">Plat typique de l’ouest, mélange de haricots et de pommes de terre pilées et cuisiné à l’huile rouge.</p>
              ...
              <div class="tab-pane" id="tab-2">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Okok</h3>
                    <p class="fst-italic">Repas du dimanche  et   incontournable des diners en famille, l’okok est un plat mythique de la cuisine camerounaise.</p>
              ...
              <div class="tab-pane" id="tab-3">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Taro sauce jaune</h3>
                    <p class="fst-italic">Originaire du nord-ouest Cameroun, le taro sauce jaune est un délicieux mets salé à déguster avec les doigts</p>
              ...
              <div class="tab-pane" id="tab-4">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Couscous sauce gombo</h3>
                    <p class="fst-italic">Retour aux sources avec cette sauce de grand-mère idéale pour la digestion.</p>
              ...
              <div class="tab-pane" id="tab-5">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Couscous nkui</h3>
                    <p class="fst-italic">L’insaisissable ! Le nkui est l’un des plats les plus prisé de certaines localités du Cameroun.</p>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="row event-item">
                <div class="col-lg-6">
                  <img src="../img/Mandara/cake1.jpg" class="img-fluid" alt="mandara anniversaire">
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0 content">
                  <h3>Anniversaires</h3>
                  <div class="price">
                    <p><span>100 000 Fcfa</span></p>
                  </div>
                  <p class="fst-italic">
            ...
            <div class="swiper-slide">
              <div class="row event-item">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content">
                  <h3>Soiré de mariage</h3>
                  <div class="price">
                    <p><span>1 000 000 Fcfa</span></p>
                  </div>
                  <p class="fst-italic">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
                    magna aliqua.
      ...
      <div class="container" data-aos="fade-up">
        ...
        <form action="{{ route('reservation') }}" method="post" role="form" class="form-costum" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 form-group mt-3">
              <input type="number" class="form-control" name="people" id="people" placeholder="Nombre de personne" data-rule="minlen:1" data-msg="S'il vous-plait, entrer au minimum 01 personne">
              <div class="validate"></div>
            </div>
          </div>
    ...
    <section id="testimonials" class="testimonials section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Qu'est-ce qu'ils en disent </p>
        </div>
      ...
      <div class="container-fluid" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../img/Mandara/Gallerie/about.jpeg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../img/Mandara/Gallerie/about.jpeg" alt="photo mandara" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../img/Mandara/Gallerie/accueil.jpeg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../img/Mandara/Gallerie/accueil.jpeg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../img/Mandara/Gallerie/feu.jpg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../img/Mandara/Gallerie/feu.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../img/Mandara/Gallerie/gallerie1.jpg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../img/Mandara/Gallerie/gallerie1.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../img/Mandara/Gallerie/gallerie2.jpg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../img/Mandara/Gallerie/gallerie2.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../img/Mandara/Gallerie/gallerie3.jpg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../img/Mandara/Gallerie/gallerie3.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../img/Mandara/Gallerie/gallerie4.jpg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../img/Mandara/Gallerie/gallerie4.jpeg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../img/Mandara/Gallerie/about.jpeg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../img/Mandara/Gallerie/about.jpeg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <img src="../img/Mandara/Chef/chef1.jpg" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="200">
              <img src="../img/Mandara/Chef/chef2.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Ngonno</h4>
                  <span>Eunice</span>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="300">
              <img src="../img/Mandara/Chef/chef3.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Kamga</h4>
                  <span>Chris</span>
    ...
    <section id="contact" class="contact">
      ...
      <div data-aos="fade-up">
        <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3979.6283496169513!2d9.738925914760136!3d4.09581199702182!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x10610d8c82cca87b%3A0xf93bdc49306b5f1d!2sMANDARA%20LOUNGE!5e0!3m2!1sfr!2scm!4v1635521678091!5m2!1sfr!2scm" frameborder="0" allowfullscreen></iframe>
      </div>
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Localisation:</h4>
                <p>Bonamoussadi face pharmacie yoro Djoss, Douala, Cameroun</p>
              </div>
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>info@mandara.com</p>
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Téléphone:</h4>
                <p>+237 6 75 00 00 00</p>
                <p>+237 6 99 00 00 00</p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="my-3">
                <div class="loading">Chargement</div>
                <div class="error-message">Une erreur s'est produite lors de l'envoi de votre message. veuillez reésayer</div>
                <div class="sent-message">Votre message a bien été bien envoyer. Thank you!</div>
              </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Mandara</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
